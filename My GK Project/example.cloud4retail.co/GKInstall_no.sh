...
case "$COMPONENT_TYPE" in
  'POS')
    systemType="CLOUD4RETAIL-OPOS-CLOUD"
    install_dir="$base_install_dir/pos-full"
    ;;
  'WDM')
    systemType="CLOUD4RETAIL-wdm"
  ...
  'FLOW-SERVICE')
    ...
    ;;
  'LPA-SERVICE')
    systemType="CLOUD4RETAIL-lps-lpa"
    install_dir="$base_install_dir/lpa-service"
    ;;
  'STOREHUB-SERVICE')
    systemType="CLOUD4RETAIL-sh-cloud"
...
case "$systemType" in
  ...
  "GKR-FLOWSERVICE-CLOUD")
    component_version="v1.0.0"
    ;;
  "CLOUD4RETAIL-lps-lpa")
    component_version="v1.0.0"
    ;;
  "CLOUD4RETAIL-sh-cloud")
    component_version="v1.0.0"
    ;;
  *)
    component_version=""
...
# Manual input only mode (automatic detection is disabled)
